...
public class FoodItem : MonoBehaviour {
    ...
    public enum FoodTypes { eggs, butter, cheese, milk, chocolate, flour, nutmeg, paprika, pepper, salt, vanilla, cream, sugar, raspberry, strawberry, lemon, potato, vinegar, oregano, parsley, apple, sweetpotato, cinnamon, crab, u, v, w, x, y, z  }
